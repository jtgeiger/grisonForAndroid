...
public class CamService extends Service {
    ...
    private final Map<MainActivity.CamSession, FoscamSession> camSessionFoscamSessionMap = new HashMap<>();
    ...
    private void startCam(final MainActivity.CamSession camSession, final Runnable dataSetChangedCallback) {
...
//                    notifyDataSetChangedOnUiThread();
                    ...
                    camSession.camStatus = success ? MainActivity.CamStatus.CONNECTED : MainActivity.CamStatus.CANT_CONNECT;
                    if (!success) {
...
//                }
    ...
    public class CamServiceBinder extends Binder {
        ...
        public void startCam(MainActivity.CamSession camSession, Runnable dataSetChangedCallback) {
